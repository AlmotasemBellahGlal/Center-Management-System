...
namespace Center_Management.Repositories
{
    public class PaymentRepository : GenericRepository<Payment>, IPaymentRepository
    {
        ...
        public async Task<bool> PaymentExistsAsync(int studentId, int groupId, int month, int year)
        {
        ...
        public async Task<IEnumerable<Student>> GetUnpaidStudentsAsync(int groupId, int month, int year)
        {
        ...
        public async Task<IEnumerable<Payment>> GetStudentPaymentsAsync(int studentId)
        {
            return await ctx.Payments
